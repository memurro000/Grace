...
concept function_system = requires(Callable function, num_t t, const vector_t & y) {
    { function(t, y) } -> std::same_as<vector_t>;
};

static_assert(function_system<function_system_t>,
              "function_system_t must fulfill function_system concept");
